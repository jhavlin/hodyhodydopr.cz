module CustomEvents exposing (onMouseDownWithButton, onMouseUpWithButton, onMouseEnterWithButtons)

import Html
import Html.Events exposing (on)
import Json.Decode exposing (Decoder, map, int, field)

withButtonDecoder : (Int -> msg) -> Decoder msg
withButtonDecoder message = map message (field "button" int)

withButtonsDecoder : (Int -> msg) -> Decoder msg
withButtonsDecoder message = map message (field "buttons" int)
